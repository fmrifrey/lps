...
%
    ...
    kmsk_in = 2*seq_args.fov/seq_args.N_nom * vecnorm(reshape(ktraj_in(:,1,:),[],3),2,2) ...
        <= min(rec_args.N/seq_args.N_nom, (rec_args.fermi_cutoff + rec_args.fermi_rolloff));
    kmsk_out = 2*seq_args.fov/seq_args.N_nom * vecnorm(reshape(ktraj_out(:,1,:),[],3),2,2) ...
        <= min(rec_args.N/seq_args.N_nom, (rec_args.fermi_cutoff + rec_args.fermi_rolloff));
    ...
    ferm_omega = @(omega) ferm_fun(rec_args.N/seq_args.N_nom/pi * vecnorm(omega,2,2), ...
