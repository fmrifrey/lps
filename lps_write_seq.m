...
%
    ...
    [g_wav,g0,rf_wav] = lpsutl.gen_lps_waveforms( ...
    ...
    % create gradient ramp waveform objects
    t_ramp = (arg.tr*1e-3  - arg.t_seg*1e-6 * arg.nspokes * (arg.nechoes+1) - arg.psd_grd_wait*1e-6) / 2;
    nramp = arg.sys.adcSamplesDivisor*ceil(t_ramp/arg.sys.gradRasterTime/arg.sys.adcSamplesDivisor);
    g_rup = 1/nramp * ((0:nramp - 1).' + 0.5) .* g0(1,:);
    g_rdn = 1/nramp * ((nramp-1:-1:0).' + 0.5) .* g0(end,:);

    % create gradient ramp-up waveform objects
    gx_rup = mr.makeArbitraryGrad( ...
        'x', 0.99*g_rup(:,1).', ...
        'system', arg.sys, ...
        'first', 0, ...
        'last', 0.99*g0(1,1));
    gy_rup = mr.makeArbitraryGrad( ...
        'y', 0.99*g_rup(:,2).', ...
        'system', arg.sys, ...
        'first', 0, ...
        'last', 0.99*g0(1,2));
    gz_rup = mr.makeArbitraryGrad( ...
        'z', 0.99*g_rup(:,3).', ...
        'system', arg.sys, ...
        'first', 0, ...
        'last', 0.99*g0(1,3));
    ...
    gx_fid = mr.makeArbitraryGrad( ...
        'x', 0.99*g_wav(:,1,1).', ...
        'system', arg.sys, ...
        'first', 0.99*g0(1,1), ...
        'last', 0.99*g0(2,1));
    gy_fid = mr.makeArbitraryGrad( ...
        'y', 0.99*g_wav(:,1,2).', ...
        'system', arg.sys, ...
        'first', 0.99*g0(1,2), ...
        'last', 0.99*g0(2,2));
    gz_fid = mr.makeArbitraryGrad( ...
        'z', 0.99*g_wav(:,1,3).', ...
        'system', arg.sys, ...
        'first', 0.99*g0(1,3), ...
        'last', 0.99*g0(2,3));
    ...
    gx_gre = mr.makeArbitraryGrad( ...
        'x', 0.99*reshape(g_wav(:,2:end,1),[],1).', ...
        'system', arg.sys, ...
        'first', 0.99*g0(2,1), ...
        'last', 0.99*g0(end,1));
    gy_gre = mr.makeArbitraryGrad( ...
        'y', 0.99*reshape(g_wav(:,2:end,2),[],1).', ...
        'system', arg.sys, ...
        'first', 0.99*g0(2,2), ...
        'last', 0.99*g0(end,2));
    gz_gre = mr.makeArbitraryGrad( ...
        'z', 0.99*reshape(g_wav(:,2:end,3),[],1).', ...
        'system', arg.sys, ...
        'first', 0.99*g0(2,3), ...
        'last', 0.99*g0(end,3));
    ...
    % create gradient ramp-down waveform objects
    gx_rdn = mr.makeArbitraryGrad( ...
        'x', 0.99*g_rdn(:,1).', ...
        'system', arg.sys, ...
        'first', 0.99*g0(end,1), ...
        'last', 0);
    gy_rdn = mr.makeArbitraryGrad( ...
        'y', 0.99*g_rdn(:,2).', ...
        'system', arg.sys, ...
        'first', 0.99*g0(end,2), ...
        'last', 0);
    gz_rdn = mr.makeArbitraryGrad( ...
        'z', 0.99*g_rdn(:,3).', ...
        'system', arg.sys, ...
        'first', 0.99*g0(end,3), ...
        'last', 0);
